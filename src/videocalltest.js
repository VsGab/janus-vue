...
// the whole session.
//
//var server = "https://" + window.location.hostname + ":8081/janus"


var server = "wss://lifemeaning.space:9001/janus";
									...
									if(result !== null && result !== undefined) {
										if(result["list"] !== undefined && result["list"] !== null) {
											...
											if (havePeer) {
												...
												$('#status').html("Peer available");
												$('#phone').removeClass('hide').show();
											} else {
												$('#status').html("Waiting for peer...");
												$('#phone').addClass('hide').hide();
											}
